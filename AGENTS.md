...
```bash
python -m py_compile main.py utools/ui/inspector.py utools/ui/operator.py utools/wechat/pay_order.py utools/components/wechat_pay_order.py utools/io/json_output.py
```
